...
plas2.line = dataimport.det_data_frame_line(dfProt, plas2)
plas2.abundance = dataimport.get_abundance(dfProt, plas2)
plas4 = Enzyme('Plasmepsin IV', 'PF14_0075', 0.02, 15, 20 * 10**(-6))
plas4.line = dataimport.det_data_frame_line(dfProt, plas4)
...
falcipain2.line = dataimport.det_data_frame_line(dfProt, falcipain2)
...
hap.line = dataimport.det_data_frame_line(dfProt, hap)
hap.abundance = dataimport.get_abundance(dfProt, hap)

falcilysin = Enzyme('Falcilysin', 'PF13_0322', 0.000317, 0.0469, 10 * 10**(-6))
falcilysin.line = dataimport.det_data_frame_line(dfProt, falcilysin)
