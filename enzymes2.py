...
iPep = Enzyme('Initial peptidases', 0, 'PF14_0077', 500 * 10**3, 30 * 10**(-6), 146, 80, 20, False)
...
fln = Enzyme('Falcilysin', 1, 'PF13_0322', 148 * 10**3, 10 * 10**(-6), 80, 30, 10, False)
...
LAMAp = Enzyme('Leucyl, Aspartyl, Methionyl Aminopeptidasen', 3, '', 1.5 * 10**3, 50 * 10**(-6), 20, 2, 1, True)
